CREATE DATABASE SALES_MANAGEMENT1;

USE SALES_MANAGEMENT1;
...
select min(MSRP) as Least_amount
from products;

select productName, count(*) as total_product
from products
...
select avg(quantityInStock) as Average_Stock
from Products
where quantityInStock > 50;

select orderStatus, count(*) as Shipped_Orders
from Orders
